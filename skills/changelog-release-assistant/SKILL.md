...
description: Maintain CHANGELOG.md in Keep a Changelog format and prepare tag-based releases.
---
...
Releases are **tag-driven**: pushing a tag `vX.Y.Z` triggers GitHub Actions to create a GitHub Release using changelog content.
